public class GamePlay{
    ...
    public static void main(String[] args){
      ...
      //Trying to set up the game logic
  ...
  3) Using if else; if value/char is equal to the x1,y1,x2,y2 (equal to all of these) print "you sunk the ship"
   ...
   /*  System.out.println("Welcome to BattleShip");
    ...
    if (int char && value == (int x1, int y1)||(int x2, inty2){
      ship [x][y] = 'x';
    ...
    else if (int char && value == (int x1, int y1);( int x2, inty2);
      System.out.println("You sunk the Ship");
       
    else if (System.out.println("You missed"));{
